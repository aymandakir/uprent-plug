...
const features = [
  { name: "Sources Monitored", rentfusion: "1,500+", findify: "500+", rentbird: "300+", rentslam: "1,000+" },
  { name: "Alert Speed", rentfusion: "15 sec", findify: "30 sec", rentbird: "60 sec", rentslam: "30 sec" },
  { name: "AI Application Letters", rentfusion: true, findify: true, rentbird: false, rentslam: true },
  { name: "Contract AI Review", rentfusion: true, findify: false, rentbird: true, rentslam: false },
  { name: "iOS/Android Apps", rentfusion: true, findify: false, rentbird: false, rentslam: false },
  { name: "Family Sharing", rentfusion: "5 members", findify: "3 members", rentbird: false, rentslam: false },
  { name: "Search Profiles", rentfusion: "5", findify: "2", rentbird: "1", rentslam: "4" },
  { name: "Monthly Price", rentfusion: "€14.99", findify: "€19.99", rentbird: "€29.99", rentslam: "€19.98" },
  { name: "Money-back Guarantee", rentfusion: "7 days", findify: "3 days", rentbird: "14 days", rentslam: "14 days" }
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 text-center">
          <h2 className="mb-4 text-4xl font-bold text-gray-900 md:text-5xl">
            Why RentFusion Beats the Competition
          </h2>
              ...
              <tr className="bg-gradient-to-r from-brand-400 to-accent-400 text-white">
                ...
                <th className="px-6 py-4 text-center font-semibold">
                  <div className="flex items-center justify-center gap-2">
                    RentFusion <span className="rounded-full bg-white/20 px-2 py-1 text-xs">YOU</span>
                  </div>
                </th>
            ...
            <tbody>
              {features.map((feature, idx) => (
                ...
                >
                  ...
                  <td className="bg-brand-50 px-6 py-4 text-center">{renderCell(feature.rentfusion, true)}</td>
