...
export const metadata: Metadata = {
  ...
  keywords: ['huur', 'huisvesting', 'Nederland', 'Amsterdam', 'Utrecht', 'Rotterdam', 'appartement zoeker', 'huurwaarschuwingen', 'Nederlandse huisvesting'],
  authors: [{ name: 'Uprent Plus' }],
  openGraph: {
    type: 'website',
    locale: 'nl_NL',
    url: 'https://uprent.nl/nl',
    title: t.metadata.title,
    description: t.metadata.description,
...
export default function DutchLandingPage() {
  return (
